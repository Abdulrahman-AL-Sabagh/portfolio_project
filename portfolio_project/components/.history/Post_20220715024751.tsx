...
type IconWithTextTypes = typeof IconWithText.this.props.first;
...
const Post: FC<{
  ...
  const interactionIcons: IconWithTextTypes[] = [
    ...
    },
    {
      ...
      changeIconSettings: changeIconSettings,
      iconName: "comments",
      weight: ICONSDEFAULTSETTINGS.comment.weight
    },
    {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {interactionIcons && interactionIcons.map((interactionIcon,index)=> {
