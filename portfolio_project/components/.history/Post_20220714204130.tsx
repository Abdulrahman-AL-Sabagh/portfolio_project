...
const Post: FC<{
  ...
  return (
    <Container
      ...
      maxWidth={750}
    >
      <Flex borderRadius={20} background={COLORS.primary} p={20} justifyContent={"space-between"} alignItems={"center"}>
      ...
      <Container borderBottomRadius={20} background={COLORS.primary} width={"full"} height={100} max-height={100}></Container>
    </Container>
  );
};
export default Post;
